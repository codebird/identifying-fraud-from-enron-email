...
'long_term_incentive', 'from_poi_to_this_person', 'stocks_money', 'di_lti', 'other_bonus', 'exp_la']
...
clf = ExtraTreesClassifier(n_jobs=-1, n_estimators=500, min_samples_split=1)
...
#print time needed to fit and predict
